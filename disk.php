...
//dynamic url: to change url after load
...
$root_path = $_SERVER['DOCUMENT_ROOT'].'/filemanage/uploads';
...
if ($use_auth) {
    if (isset($_SESSION[FM_SESSION_ID]['logged'], $auth_users[$_SESSION[FM_SESSION_ID]['logged']])) {
        ...
        fm_show_header_login();
        ?>
        <section bgcolor='black' textcolor='red'>
        <div bg color='green'>
                                ...
                                <form class="" action="" method="post" autocomplete="off">
                                    ...
                                    <div class="">
                                        ...
                                        <input type="text" class="" id="fm_usr" name="fm_usr" required autofocus>
                                    </div>

                                    <div class="">
                                        <label for="fm_pwd"><?php echo lng('Password'); ?></label>
                                        <input type="password" class="" id="fm_pwd" name="fm_pwd" required>
                                    </div>
                        ...
                        <div class="">
                            &mdash;&mdash; &copy;
                            <a href="https://paperlab.github.io" target="_blank" class="" data-version="<?php echo VERSION; ?>">Devloped by: PaperLab Corporation</a> &mdash;&mdash;
                        </div>
 ...
 class FM_Config
{
    ...
    function __construct()
    {
        ...
        if (strlen($CONFIG)) {
            ...
            $msg = 'Paperlab NAS<br>Error: Cannot load configuration';
            if (substr($fm_url, -1) == '/') {
                $fm_url = rtrim($fm_url, '/');
                $msg .= '<br>';
                ...
                <ul class="navbar-nav mr-auto float-right <?php echo fm_get_theme();  ?>">
                    ...
                    <?php else: ?>
                        <?php if (!FM_READONLY): ?>
                            ...
                            <li>
                                <a title="<?php echo lng('Log Out') ?>" class="dropdown-item nav-link" href="logout.php"><i class="fa fa-cog" aria-hidden="false"></i> <?php echo lng('Log out') ?></a>   
                            </li>
                        <?php endif; ?>
                    <?php endif; ?>
                </ul>
